...
Event OnEffectStart(Actor Target, Actor Caster)
	...
	Float firedamage = mag * (1 - Target.GetActorValue("FireResist") / 100)
	Float frostdamage = mag * (1 - Target.GetActorValue("FrostResist") / 100)
	Float shockdamage = mag * (1 - Target.GetActorValue("ElectricResist") / 100)
