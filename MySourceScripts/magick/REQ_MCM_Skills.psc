...
Event OnPageReset(String page)
	...
	ElseIf page == "$REQ_cat_skill0" 
		...
		AddTextOptionST("w", "Сопротивление стрелам и болтам", player.getAV("SpeechcraftSkillAdvance") as Int + "%")
    ...
    ElseIf page == "$REQ_cat_skill1" 
		...
		;Масса
		index = data.derived.find("Mass") ; Масса
		...
		;Увеличение эффективности чар в снаряжении
    ...
    ElseIf page == "$REQ_cat_skill_expertise"
		...
		self.AddTextOptionST("n", "Перезарядка криков", ((((1.0 - Player.GetAV("ShoutRecoveryMult")) * 100) + 0.3) as Int) as String + "%", 0)
		self.AddTextOptionST("a", "Удешевление навыка разрушения", (Player.getAV("DestructionMod") as Int) as String + "%", 0)
		self.AddTextOptionST("b", "Удешевление навыка иллюзии", (Player.getAV("IllusionMod") as Int) as String + "%", 0)
		self.AddTextOptionST("c", "Удешевление навыка изменения", (Player.getAV("AlterationMod") as Int) as String + "%", 0)
		self.AddTextOptionST("d", "Удешевление навыка восстановления", (Player.getAV("Restoration") as Int) as String + "%", 0)
		self.AddTextOptionST("e", "Удешевление навыка колдовства", (Player.getAV("Conjuration") as Int) as String + "%", 0)
		self.AddTextOptionST("f", "Повышение навыка разрушения", ((Player.getAV("Destruction") - Player.GetBaseAV("Destruction")) as Int) as String, 0)
		self.AddTextOptionST("g", "Повышение навыка иллюзии", ((Player.getAV("Illusion") - Player.GetBaseAV("Illusion")) as Int) as String, 0)
		self.AddTextOptionST("h", "Повышение навыка изменения", ((Player.getAV("Alteration") - Player.GetBaseAV("Alteration")) as Int) as String, 0)
		self.AddTextOptionST("j", "Повышение навыка восстановления", ((Player.getAV("Restoration") - Player.GetBaseAV("Restoration")) as Int) as String, 0)
		self.AddTextOptionST("k", "Повышение навыка колдовства", ((Player.getAV("Conjuration") - Player.GetBaseAV("Conjuration")) as Int) as String, 0)
    EndIf
EndEvent
