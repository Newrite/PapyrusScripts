Scriptname ADV_Throw_Torch extends activemagiceffect  
...
Light Property Torch_Throw Auto   
...
if PlayerRef.GetAV("Stamina") < 10
    Debug.Notification("Недостаточно стамины")
        return 
endIf
if PlayerRef.GetItemCount(Torch_Throw) == 0
    Debug.Notification("Факелы закончились")
        return 
endIf
...
Event OnActorAction(int actionType, Actor akActor, Form source, int slot)
        ...
        PlayerRef.RemoveItem(Torch_Throw, 1,true)
        Endif
