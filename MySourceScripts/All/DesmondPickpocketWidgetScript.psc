...
keyword property BottleShock auto
keyword property BottlePoison auto
...
Bool shockBottleIconVisible = false
Bool poisonBottleIconVisible = false
...
function SetPowders()
	...
	shockBottleIconVisible = false
	poisonBottleIconVisible = false
...
function SetBottles()
	...
	poisonBottleIconVisible = Player.WornHasKeyword(BottlePoison)
	shockBottleIconVisible = Player.WornHasKeyword(BottleShock)
	daggerIconVisible = false
	pawIconVisible = false
endFunction
...
function render()
	...
	ui.InvokeBool(self.HUD_MENU, self.WidgetRoot + ".setShockBottleIconVisible", shockBottleIconVisible)
	ui.InvokeBool(self.HUD_MENU, self.WidgetRoot + ".setPoisonBottleIconVisible", poisonBottleIconVisible)
