Scriptname MRL_IdealBalancePerk_AB extends ActiveMagicEffect
...
string SneakSkillAdvance = "SneakSkillAdvance"
...
Function ChangeValues(float modifer)
	...
	Caster.ModActorValue(SneakSkillAdvance, ((modifer / 10.0) * 2.0))
