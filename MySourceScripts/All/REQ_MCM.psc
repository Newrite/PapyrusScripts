...
State REQ_Combat_NoDeathHandling
    ...
    Event OnSelectST()
        ...
        If (!data.REQ_Combat_NoDeathHandling.GetValueInt() as Bool)
            SetOptionFlagsST(OPTION_FLAG_DISABLED, false, "fPlayerDeathReloadTime")
            Game.SetGameSettingfloat("fPlayerDeathReloadTime", 3600)
        Else
            SetOptionFlagsST(OPTION_FLAG_NONE, false, "fPlayerDeathReloadTime")
...
State fPlayerDeathReloadTime

    Event OnSliderOpenST()
        SetSliderDialogStartValue(Game.GetGameSettingfloat("fPlayerDeathReloadTime") / 1.0)
        SetSliderDialogDefaultValue(Game.GetGameSettingfloat("fPlayerDeathReloadTime") / 1.0)
        SetSliderDialogRange(0.0, 10.0)
        SetSliderDialogInterval(0.2)
    EndEvent

    Event OnSliderAcceptST(float value)
        data.fPlayerDeathReloadTime = (value * 1.0) as float
        Game.SetGameSettingfloat("fPlayerDeathReloadTime", data.fPlayerDeathReloadTime)
        SetSliderOptionValueST(Game.GetGameSettingfloat("fPlayerDeathReloadTime") / 1.0,"$REQ_fPlayerDeathReloadTime_slider")
    EndEvent

    Event OnDefaultST()
        data.fPlayerDeathReloadTime = 5.0 as float
        Game.SetGameSettingfloat("fPlayerDeathReloadTime", data.fPlayerDeathReloadTime)
        SetSliderOptionValueST(Game.GetGameSettingfloat("fPlayerDeathReloadTime") / 1.0,"$REQ_fPlayerDeathReloadTime_slider")
    EndEvent

    Event OnHighlightST()
        SetInfoText("$REQ_fPlayerDeathReloadTime_highlight")
    EndEvent
...
Event OnPageReset(String page)
    ...
    ElseIf page == "$REQ_cat_0"
        ...
        If (data.REQ_Combat_NoDeathHandling.GetValueInt() as Bool)
            AddSliderOptionST("fPlayerDeathReloadTime",  "$REQ_fPlayerDeathReloadTime", Game.GetGameSettingfloat("fPlayerDeathReloadTime") / 1.0, "$REQ_fPlayerDeathReloadTime_slider")
        Else
            AddSliderOptionST("fPlayerDeathReloadTime",  "$REQ_fPlayerDeathReloadTime", Game.GetGameSettingfloat("fPlayerDeathReloadTime") / 1.0, "$REQ_fPlayerDeathReloadTime_slider", OPTION_FLAG_DISABLED)
        EndIf
		data.fDiffMultHPByPCL = 1 as float
		data.fDiffMultHPToPCL = 1 as float
