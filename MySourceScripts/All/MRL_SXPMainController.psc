...
ActorValueInfo[] Function GetSkillsAVI()
  return SkillsAVI
EndFunction
...
Event OnInit()
  Debug.Notification("RFAD - Experience инициализируется, не открывайте пока МСМ...")
  ...
  Debug.Notification("RFAD - Experience готов к работе.")
EndEvent
