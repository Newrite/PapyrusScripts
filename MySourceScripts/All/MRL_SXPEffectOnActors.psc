...
Auto State DoOnceState
	...
	Event onDying(actor myKiller)
		If !myKiller
			If (VictimActor.IsHostileToActor(Game.GetPlayer()) && (Time > Utility.GetCurrentRealTime() || Utility.GetCurrentRealTime() > Time + 2.0) && VictimActor.GetActorValue("Health") < 0.0) || myKiller.HasMagicEffectWithKeyword(MagicInfluenceFrenzy)
