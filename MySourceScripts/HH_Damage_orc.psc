Scriptname HH_Damage_orc extends activemagiceffect  
...
float Base = 85 ; базовый урон кинжала 
...
Dmg=Dmg*0.1 ; Урон по нежити 10% 
endIf 
float penetr= 0.15 + HH_GL_Perk_penetr.GetValue()+((K2-K1)*0.005) ; пробитие 
if penetr>0.8 
penetr = 0.8 
endIf 
