...
Potion Property RedWaterBloodPotion Auto
...
Event OnActivate(ObjectReference ActivateRef)
	;Источник также наполняет пустые флаконы с кровью своей силой
	...
	if EmptyPotionCount >= 1
		...
		Game.GetPlayer().AddItem(RedWaterBloodPotion as Form, EmptyPotionCount, false)
	endif
