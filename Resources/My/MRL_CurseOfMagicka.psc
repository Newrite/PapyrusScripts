...
Spell Property descSpell1 auto
Spell Property descSpell2 auto
Spell Property descSpell3 auto
...
function updateAbility()
	cursedActor.RemoveSpell(descSpell1)
	cursedActor.RemoveSpell(descSpell2)
	cursedActor.RemoveSpell(descSpell3)
	float EnchantingSkillAdvance = cursedActor.GetActorValue("EnchantingSkillAdvance") as Float
	if EnchantingSkillAdvance >= 100.0
		descSpell1.SetNthEffectMagnitude(0, 20.0)
		descSpell2.SetNthEffectMagnitude(0, 50.0)
		descSpell3.SetNthEffectMagnitude(0, 25.0)
		descSpell1.SetNthEffectMagnitude(1, 10.0)
		descSpell2.SetNthEffectMagnitude(1, 25.0)
		descSpell3.SetNthEffectMagnitude(1, 12.5)
	else
		descSpell1.SetNthEffectMagnitude(0, EnchantingSkillAdvance * 0.2)
		descSpell2.SetNthEffectMagnitude(0, EnchantingSkillAdvance * 0.5)
		descSpell3.SetNthEffectMagnitude(0, EnchantingSkillAdvance * 0.25)
		descSpell1.SetNthEffectMagnitude(1, EnchantingSkillAdvance * 0.1)
		descSpell2.SetNthEffectMagnitude(1, EnchantingSkillAdvance * 0.25)
		descSpell3.SetNthEffectMagnitude(1, EnchantingSkillAdvance * 0.125)
	endif
	cursedActor.AddSpell(descSpell1, false)
	cursedActor.AddSpell(descSpell2, false)
	cursedActor.AddSpell(descSpell3, false)
endFunction
