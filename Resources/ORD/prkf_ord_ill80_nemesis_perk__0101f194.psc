...
Scriptname PRKF_ORD_Ill80_Nemesis_Perk__0101F194 Extends Perk Hidden

;BEGIN FRAGMENT Fragment_0
Function Fragment_0(ObjectReference akTargetRef, Actor akActor)
;BEGIN CODE
Float NextActivateTime = GameDaysPassed.GetValue() + ORD_DayFraction
;ORD_Ill_Nemesis_Global_NextActivate.SetValue(NextActivateTime)
PlayerRef.DoCombatSpellApply(ORD_Ill_Nemesis_Spell_Proc, (akTargetRef as Actor))
Game.AdvanceSkill("Illusion", ORD_XP)
ORD_Ill_CooldownEnd_Spell_Nemesis.Cast(PlayerRef)
;END CODE
EndFunction
;END FRAGMENT
